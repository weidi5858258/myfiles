...
namespace android {
    ...
    public:
        explicit BpAudioTrack(const sp<IBinder> &impl) :
            ...
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::BpAudioTrack()  created   %p PID: %d", this, pid);
        }

        ~BpAudioTrack() {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::~BpAudioTrack() destroyed %p PID: %d", this, pid);
        }

        virtual sp<IMemory> getCblk() const {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::getCblk() %p PID: %d", this, pid);
            Parcel data, reply;
            sp<IMemory> cblk;
        ...
        virtual status_t start() {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::start() %p PID: %d", this, pid);
            Parcel data, reply;
            data.writeInterfaceToken(IAudioTrack::getInterfaceDescriptor());
        ...
        virtual void stop() {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::stop() %p PID: %d", this, pid);
            Parcel data, reply;
            data.writeInterfaceToken(IAudioTrack::getInterfaceDescriptor());
        ...
        virtual void flush() {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::flush() %p PID: %d", this, pid);
            Parcel data, reply;
            data.writeInterfaceToken(IAudioTrack::getInterfaceDescriptor());
        ...
        virtual void pause() {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::pause() %p PID: %d", this, pid);
            Parcel data, reply;
            data.writeInterfaceToken(IAudioTrack::getInterfaceDescriptor());
        ...
        virtual status_t attachAuxEffect(int effectId) {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::attachAuxEffect() %p PID: %d", this, pid);
            Parcel data, reply;
            data.writeInterfaceToken(IAudioTrack::getInterfaceDescriptor());
        ...
        virtual status_t setParameters(const String8 &keyValuePairs) {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::setParameters() %p PID: %d", this, pid);
            Parcel data, reply;
            data.writeInterfaceToken(IAudioTrack::getInterfaceDescriptor());
        ...
        virtual status_t getTimestamp(AudioTimestamp &timestamp) {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::getTimestamp() %p PID: %d", this, pid);
            Parcel data, reply;
            data.writeInterfaceToken(IAudioTrack::getInterfaceDescriptor());
        ...
        virtual void signal() {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::signal() %p PID: %d", this, pid);
            Parcel data, reply;
            data.writeInterfaceToken(IAudioTrack::getInterfaceDescriptor());
        ...
        virtual VolumeShaper::Status applyVolumeShaper(
            ...
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::applyVolumeShaper() %p PID: %d", this, pid);
            Parcel data, reply;
            data.writeInterfaceToken(IAudioTrack::getInterfaceDescriptor());
        ...
        virtual sp<VolumeShaper::State> getVolumeShaperState(int id) {
            pid_t pid = getpid();
            ALOGD("BpAudioTrack::getVolumeShaperState() %p PID: %d", this, pid);
            Parcel data, reply;
            data.writeInterfaceToken(IAudioTrack::getInterfaceDescriptor());
...
// ----------------------------------------------------------------------
    ...
    status_t BnAudioTrack::onTransact(
        ...
        pid_t pid = getpid();
        ALOGD("BnAudioTrack::onTransact() %p PID: %d", this, pid);
        switch (code) {
            case GET_CBLK: {
