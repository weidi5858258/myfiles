      ...
      mRoutedDeviceId(AUDIO_PORT_HANDLE_NONE)
{
    pid_t pid = getpid();
    uid_t uid = getuid();
    ALOGD("AudioTrack()  PID: %d UID: %d", pid, uid);
        ...
        audio_port_handle_t selectedDeviceId)
{
    ...
    ALOGD("AudioTrack::set()  streamType: %d sampleRate: %u format: %#x "
          "channelMask: %#x frameCount: %zu flags: #%x "
          "notificationFrames: %d threadCanCallJava: %d sessionId: %d "
          "transferType: %d pid: %d uid: %d "
          "doNotReconnect: %d maxRequiredSpeed: %d selectedDeviceId: %d",
          streamType, sampleRate, format,
          channelMask, frameCount, flags,
          notificationFrames, threadCanCallJava, sessionId,
          transferType, pid, uid,
