...
static int stream_component_open(VideoState *is, int stream_index) {
    ...
    dictionary = filter_codec_opts(codec_opts, avctx->codec_id, ic, ic->streams[stream_index], deCodec);
    ...
    if ((ret = avcodec_open2(avctx, deCodec, &dictionary)) < 0) {
        goto fail;
    }
